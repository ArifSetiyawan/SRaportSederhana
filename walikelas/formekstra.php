                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                <header>
                                    ...
                                    <h5>Input Data Ekstrakurikuler</h5>
                                </header>
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="simpanekstra.php" class="form-horizontal" method="post">
									
                                        <input type="hidden" name="id_ekstra" id="id_ekstra"  class="form-control" />
