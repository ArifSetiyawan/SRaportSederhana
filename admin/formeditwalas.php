...
$query=mysql_query("SELECT * FROM `walas` WHERE id_walas='$id_walas'");
?>
    <!-- MAIN WRAPPER -->
    <div id="wrap" >
   <!-- HEADER SECTION -->
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                <header>
                                    ...
                                    <h5>Edit Data Walikelas</h5>
                                </header>
                                <div id="collapseOne" class="accordion-body collapse in body">
								<form action="editwalas.php" class="form-horizontal" method="post">
									<?php
									while($data=mysql_fetch_array($query))
								{
								?>
                                        <input type="hidden" name="id_walas" id="id_walas" value="<?php echo $data['id_walas'];?>" class="form-control" />
