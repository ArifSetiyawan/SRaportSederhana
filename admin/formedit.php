                ...
                <div class="inner">
                        ...
                        <div class="col-lg-12">
                            <div class="box">
								...
								<form action="editsiswa.php" class="form-horizontal" method="post">
									<?php
									while($data=mysql_fetch_array($query))
								{
								?>
                                        <input type="hidden" name="id_siswa" id="id_siswa" value="<?php echo $data['id_siswa'];?>" class="form-control" />
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">NIS</label>
                                            <div class="col-lg-4">
                                                <input type="text" id="nis" name="nis" value="<?php echo $data['nis'];?>" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="form-group">
