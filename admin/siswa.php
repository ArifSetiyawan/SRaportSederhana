            ...
            <div class='inner'>
                ...
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        ...
                        <p><a href='formsiswa.php'><button class='btn btn-success'> Tambah Data </button></a></p>
                            <div class='table-responsive'>
                                <table class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                    ...
                                    <tr>
                                          ...
                                          <td>$agama</td>
                                          <td>$alamat</td>
                                          <td><div align='center'><a href='formedit.php?id_siswa=$data[id_siswa]'><button class='btn btn-primary'><i class='icon-pencil icon-white'></i></button></a> <a href='hapussiswa.php?id_siswa=$data[id_siswa]'><button class='btn btn-danger'><i class='icon-remove icon-white'></i></button></a></td></div>
                                        </tr>"; ?>
